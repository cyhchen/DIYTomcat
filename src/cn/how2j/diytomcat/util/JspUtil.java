...
public class JspUtil {
    ...
    public static void main(String[] args) {
        try {
            Context context = new Context("/JavaWeb", "D:/OneDrive/laptop-D/projects/tomcat/JavaWeb/web", null,true);
            File file = new File("D:/OneDrive/laptop-D/projects/tomcat/JavaWeb/web/index.jsp");
